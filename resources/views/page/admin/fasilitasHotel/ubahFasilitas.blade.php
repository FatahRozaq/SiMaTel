@extends('layouts.base_admin.base_dashboard') @section('judul', 'Ubah Fasilitas Hotel')
@section('content')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Ubah Fasilitas Hotel</li>
                </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    autocomplete="status"
                                >
                                    <option value="Buka" @if($fasilitas->status === 'Buka') selected @endif>Buka</option>
                                    <option value="Penuh" @if($fasilitas->status === 'Penuh') selected @endif>Penuh</option>
                                    <option value="Perbaikan" @if($fasilitas->status === 'Perbaikan') selected @endif>Perbaikan</option>
